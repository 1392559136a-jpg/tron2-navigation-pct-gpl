...
In GTSAM 4 a new and more efficient implementation, based on integrating on the NavState tangent space and detailed in [this document](https://raw.githubusercontent.com/byangw/PCT_planner/35cd73fd82bcd51bc538429294af7646b2a09815/planner/lib/3rdparty/gtsam-4.1.1/doc/ImuFactor.pdf), is enabled by default. To switch to the RSS 2015 version, set the flag `GTSAM_TANGENT_PREINTEGRATION` to OFF.
